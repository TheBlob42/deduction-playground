...
{:name "test2", :given [(at x (and a b))], :conclusion [(at x (and b a))], :proof [{:id 1, :body (at x (and a b)), :rule :premise} {:id 4, :body (at x a), :rule "\"and-e1\" (1)"} {:id 5, :body (at x b), :rule "\"and-e2\" (1)"} {:id 7, :body (at x (and b a)), :rule "\"and-i\" (4 5)"}]}
{:name "blabla", :given [(at x (and a e))], :conclusion [(at x (and e a))], :proof [{:id 1, :body (at x (and a e)), :rule :premise} {:id 4, :body (at x a), :rule "\"and-e1\" (1)"} {:id 5, :body (at x e), :rule "\"and-e2\" (1)"} {:id 7, :body (at x (and e a)), :rule "\"and-i\" (4 5)"}]}
